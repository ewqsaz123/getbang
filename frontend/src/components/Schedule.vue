<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <Number label="CafeId" v-model="value.cafeId" :editMode="editMode"/>
            <String label="CafeName" v-model="value.cafeName" :editMode="editMode"/>
            <Date label="ReservationDate" v-model="value.reservationDate" :editMode="editMode"/>
            <String label="RoomStatus" v-model="value.roomStatus" :editMode="editMode"/>
            <Date label="CreateAt" v-model="value.createAt" :editMode="editMode"/>
            <Date label="UpdateAt" v-model="value.updateAt" :editMode="editMode"/>
        </v-card-text>
